...
(function () {
    ...
    var TradingView = {
        host: window.location.host.match(/eotpro\.com|mrn\.eotpro\.net|tradingview\.com|pyrrosinvestment\.com/i) == null ? "https://s.tradingview.com" : "https://www.tradingview.com",
        ...
        gId: function () {
            return "tradingview_" + ((1 + Math.random()) * 1048576 | 0)
                .toString(16)
                .substring(1)
        },
        ...
        QuotesProvider: function (options) {
            ...
            this.options.type = "quotes-provider";
            var widget_url = TradingView.host + "/embed-quotes-provider/?" + TradingView.generateUtmForUrlParams(this.options);
    ...
    TradingView.widget.prototype = {
        create: function () {
            ...
            if (!this.options.noLogoOverlay && this.options.fundamental) {
                ...
                var href = "http://www.tradingview.com?" + TradingView.generateUtmForUrlParams(this.options);
                var tvLink = '<a href="' + href + '" rel="nofollow" target="_blank" style="color: #3BB3E4">TradingView.com</a>';
                newQuotes.innerHTML = "Fundamental data is powered by " + tvLink;
                ...
                newQuotes.style.fontFamily = "'Trebuchet MS', Tahoma, Arial, sans-serif";
                newQuotes.style.fontSize = "13px";
                newQuotes.style.color = "#ADAEB0";
            ...
            self.postMessage.on("logoCreated", function (data) {
                if (data.left && data.bottom && data.width && data.height && data.href) {
                    ...
                    self._logoOverlay = a;
                    TradingView.gEl(self.id + "-wrapper")
                        .appendChild(a)
                }
            });
    ...
    TradingView.showSignIn = function (options, callback) {
        TradingView.dependenciesManager.depends(["/static/js/external/spin.min.js"], "authWidget", function () {
