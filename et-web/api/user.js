...
//     return request({
//         url: `https://service.exchain.com/api/user/login`,
//         method: 'post',
//         data
//     })
// }
...
export function verifyResetPassword(data) {
    return request({
        url: `http://service.exchain.com/api/user/verifyResetPassword`,
        method: 'post',
        data
    })
}
...
export function resetPassword(data) {
    return request({
        url: `http://service.exchain.com/api/user/resetPassword`,
        method: 'post',
        data
    })
}